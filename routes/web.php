...
use App\Http\Controllers\Admin\CouponsReportController;
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::prefix('reports')->name('reports.')->group(function () {
            ...
            Route::get('/payments', [PaymentsReportController::class, 'index'])->name('payments.index');
            Route::get('/payments/export', [PaymentsReportController::class, 'export'])->name('payments.export');
            Route::get('/coupons', [CouponsReportController::class, 'index'])->name('coupons.index');
            Route::get('/coupons/export', [CouponsReportController::class, 'export'])->name('coupons.export');
