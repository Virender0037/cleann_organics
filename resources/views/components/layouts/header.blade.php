...
<body>
@include('components.frontend.flash-messages')
<div class="loader">
...
<div class="shopping-cart" id="mini-cart">
    @include('components.frontend.cart-mini-contents', ['lines' => $cartLines, 'subtotal' => $cartSubtotal, 'itemCount' => $cartItemCount])
</div>
        ...
        <div class="header__cart-item">
            <div class="header__cart-item-content" id="cart-bag">
                <button class="cart-bag" aria-label="Open shopping cart">
                    ...
                    <span class="item-number" id="mini-cart-count">{{ $cartItemCount }}</span>
                </button>
                <div class="header__cart-item-content-info">
                    <h5>Shopping cart:</h5>
                    <span class="price" id="mini-cart-subtotal">₹{{ number_format($cartSubtotal, 2) }}</span>
                </div>
            </div>
        </div>
    </div>
