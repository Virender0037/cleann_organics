        ...
        <div class="row dashboard__content">
          <div class="col-lg-3">
            <nav class="dashboard__nav">
              <h2 class="dashboard__nav-title font-body--xxl-500">navigation</h2>
                      ...
                      <div class="dashboard__totalpayment-card">
                        <div class="dashboard__totalpayment-card-header">
                          ...
                          <div class="dashboard__totalpayment-card-header-item">
                            ...
                            <p class="details order-id" style="text-transform:uppercase;">{{ str_replace('_', ' ', $order->payment_method) }}</p>
                          </div>
                          <div class="dashboard__totalpayment-card-header-item">
                            <h5 class="title">Payment Status:</h5>
                            <p class="details order-id" style="text-transform:capitalize;">{{ $order->payment_status }}</p>
                          </div>
                        </div>
