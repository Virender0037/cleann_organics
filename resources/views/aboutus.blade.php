<x-layouts.app>
                ...
                <div class="row hero__content">
                    ...
                    <div class="col-lg-6 order-lg-0 order-1">
                        <div class="hero__img-wrapper">
                            <img src="{{ asset('images/members/img-08.png') }}" alt="img" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hero hero--two section section--xl">
            <div class="hero__img-wrapper-two-bg">
                <img src="{{ asset('images/banner/banner-lg-12.png') }}" alt="banner-lg" />
            </div>
            <div class="container">
                <div class="row hero__content">
        ...
        <section class="hero section--xl section">
            <div class="container">
                <div class="row hero__content">
                    ...
                    <div class="col-lg-6">
                        <div class="hero__img-wrapper">
                            <img src="{{ asset('images/members/img-09.png') }}" alt="img"  class="img-fluid"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="members-slider--one swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="cards-mb">
                                <div class="cards-mb__img-wrapper">
                                    <img src="{{ asset('images/members/img-01.png') }}" alt="members" />
                        ...
                        <div class="swiper-slide">
                            <div class="cards-mb">
                                <div class="cards-mb__img-wrapper">
                                    <img src="{{ asset('images/members/img-02.png') }}" alt="members" />
                                    <div class="cards-mb__img-wrapper--social">
                                        <!-- fb -->
                                        <span>
                                            <a href="#">
                        ...
                        <div class="swiper-slide">
                            <div class="cards-mb">
                                <div class="cards-mb__img-wrapper">
                                    <img src="{{ asset('images/members/img-03.png') }}" alt="members" />
                                    <div class="cards-mb__img-wrapper--social">
                                        <!-- fb -->
                                        <span>
                                            <a href="#">
        ...
        <div class="brand-name section section--lg">
            <div class="container">
