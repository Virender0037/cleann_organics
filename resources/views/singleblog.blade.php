                  ...
                  <div class="blog-gallery">
                    <div class="blog-gallery__item">
                      <a href="#" class="cards-ig">
                        <div class="cards-ig__img">
                          <img
                            src="{{ asset('images/instagram//img-01-sm.png') }}"
                            alt="ig"
                          />
                    ...
                    <div class="blog-gallery__item">
                      <a href="#" class="cards-ig">
                        <div class="cards-ig__img">
                          <img
                            src="{{ asset('images/instagram//img-02-sm.png') }}"
                            alt="ig"
                          />
                          <div class="cards-ig__overlay">
                            <span>
                    ...
                    <div class="blog-gallery__item">
                      <a href="#" class="cards-ig">
                        <div class="cards-ig__img">
                          <img
                            src="{{ asset('images/instagram//img-03-sm.png') }}"
                            alt="ig"
                          />
                          <div class="cards-ig__overlay">
                            <span>
                    ...
                    <div class="blog-gallery__item">
                      <a href="#" class="cards-ig">
                        <div class="cards-ig__img">
                          <img
                            src="{{ asset('images/instagram//img-04-sm.png') }}"
                            alt="ig"
                          />
                          <div class="cards-ig__overlay">
                            <span>
                    ...
                    <div class="blog-gallery__item">
                      <a href="#" class="cards-ig">
                        <div class="cards-ig__img">
                          <img
                            src="{{ asset('images/instagram//img-05-sm.png') }}"
                            alt="ig"
                          />
                          <div class="cards-ig__overlay">
                            <span>
                    ...
                    <div class="blog-gallery__item">
                      <a href="#" class="cards-ig">
                        <div class="cards-ig__img">
                          <img
                            src="{{ asset('images/instagram//img-06-sm.png') }}"
                            alt="ig"
                          />
                          <div class="cards-ig__overlay">
                            <span>
                    ...
                    <div class="blog-gallery__item">
                      <a href="#" class="cards-ig">
                        <div class="cards-ig__img">
                          <img
                            src="{{ asset('images/instagram//img-07-sm.png') }}"
                            alt="ig"
                          />
                          <div class="cards-ig__overlay">
                            <span>
                    ...
                    <div class="blog-gallery__item">
                      <a href="#" class="cards-ig">
                        <div class="cards-ig__img">
                          <img
                            src="{{ asset('images/instagram//img-08-sm.png') }}"
                            alt="ig"
                          />
                          <div class="cards-ig__overlay">
                            <span>
