<x-admin-layout title="Add Role">
<main class="pc-container-edit">

<x-admin.not-implemented what="Adding a role" />

<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1">Add Role</h4>
        <p class="text-muted mb-0">Create admin role with permissions</p>
    </div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="name" class="form-control" placeholder="Store Manager">
            </div>
