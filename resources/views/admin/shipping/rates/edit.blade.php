...
<main class="pc-container-edit">
    ...
    <x-admin.page-header title="Edit Shipping Rate" subtitle="Update shipping charge details">
        <x-slot:actions>
    ...
    <x-admin.form-card title="Rate Information" action="{{ route('admin.shipping.rates.update', $rate) }}" method="PUT">
        <x-slot:actions>
