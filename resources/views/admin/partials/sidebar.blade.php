        ...
        <div class="dropdown-body text-wrap header-notification-scroll position-relative" style="max-height: calc(100vh - 215px)">
            ...
            <div class="card-body">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img class="img-radius avatar rounded-0" src="{{ asset('assets/images/user/avatar-1.png') }}" alt="Generic placeholder image" />
                </div>
          ...
          <div class="card bg-transparent mb-0">
            <div class="card-body">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img class="img-radius avatar rounded-0" src="{{ asset('assets/images/user/avatar-2.png') }}" alt="Generic placeholder image" />
                </div>
                <div class="flex-grow-1 ms-3">
          ...
          <div class="card bg-transparent mb-0">
            <div class="card-body">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img class="img-radius avatar rounded-0" src="{{ asset('assets/images/user/avatar-3.png') }}" alt="Generic placeholder image" />
                </div>
                <div class="flex-grow-1 ms-3">
          ...
          <div class="card bg-transparent mb-0">
            <div class="card-body">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img class="img-radius avatar rounded-0" src="{{ asset('assets/images/user/avatar-4.png') }}" alt="Generic placeholder image" />
                </div>
                <div class="flex-grow-1 ms-3">
          ...
          <div class="card bg-transparent mb-0">
            <div class="card-body">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img class="img-radius avatar rounded-0" src="{{ asset('assets/images/user/avatar-5.png') }}" alt="Generic placeholder image" />
                </div>
                <div class="flex-grow-1 ms-3">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown p-0 overflow-hidden">
        <div class="dropdown-header d-flex align-items-center justify-content-between bg-primary">
          <div class="d-flex my-2">
            <div class="flex-shrink-0">
              <img src="{{ asset('assets/images/user/avatar-2.png') }}" alt="user-image" class="user-avatar wid-35" />
            </div>
            <div class="flex-grow-1 ms-3">
