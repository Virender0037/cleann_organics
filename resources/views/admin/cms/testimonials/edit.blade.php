<x-admin-layout title="Edit Testimonial">
    <main class="pc-container-edit">
        ...
        <x-admin.page-header title="Edit Testimonial" subtitle="Update customer testimonial">
            <x-slot:actions>
        ...
        <x-admin.form-card title="Testimonial Information" action="{{ route('admin.cms.testimonials.update', $testimonial) }}" method="PUT" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="city" class="form-control @error('city') is-invalid @enderror" value="{{ old('city', $testimonial->city) }}">
