...
<main class="pc-container-edit">
    ...
    <x-admin.page-header title="Add Blog Tag" subtitle="Create a new tag for blog articles">
        <x-slot:actions>
    ...
    <x-admin.form-card title="Tag Information" action="{{ route('admin.cms.blog-tags.store') }}" method="POST">
        <x-slot:actions>
            <a href="{{ route('admin.cms.blog-tags.index') }}" class="btn btn-light">
                Cancel
            </a>
