<x-admin-layout title="Edit Product">
    ...
    <x-admin.page-header title="Edit Product" subtitle="Update product basic information">
        <x-slot:actions>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div id="specifications-container">
                    @forelse (old('specifications', $product->specifications->map(fn ($spec) => ['title' => $spec->title, 'value' => $spec->value])->all()) as $index => $spec)
                        <div class="row specification-row mb-2 align-items-start">
                            <div class="col-md-5">
                                <input type="text" name="specifications[{{ $index }}][title]" class="form-control @error('specifications.'.$index.'.title') is-invalid @enderror" placeholder="e.g. Weight" value="{{ $spec['title'] ?? '' }}">
                                @error('specifications.'.$index.'.title') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="specifications[{{ $index }}][value]" class="form-control" placeholder="e.g. 500g" value="{{ $spec['value'] ?? '' }}">
                            </div>
                            <div class="col-md-1">
                    ...
                    @empty
                        <div class="row specification-row mb-2 align-items-start">
                            <div class="col-md-5">
                                <input type="text" name="specifications[0][title]" class="form-control" placeholder="e.g. Weight">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="specifications[0][value]" class="form-control" placeholder="e.g. 500g">
                            </div>
                            <div class="col-md-1">
                                <button type="button" class="btn btn-sm btn-danger remove-specification">
                                    <i class="ph ph-trash"></i>
    ...
    <script>
        (function () {
            ...
            var nextIndex = container.querySelectorAll('.specification-row').length;
